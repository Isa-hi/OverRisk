...
const STEPS = [
  {
    name: "Paso 1: Sube una imagen",
    description: "Elige una imagen para tu prenda",
    url: "/upload",
  },
  {
    name: "Paso 2: Personaliza el diseño",
    description: "Coloca el diseño en la prenda",
    url: "/design",
  },
  {
    name: "Paso 3: Resumen",
    description: "Revisa tu diseño y confirma tu pedido",
    url: "/preview",
  },
];
  ...
  return (
    <ol className="rounded-md bg-white lg:flex lg:rounded-none lg:border-1 lg:border-r lg:border-gray-200">
      {STEPS.map((step, index) => {
        ...
        const imgPath = `/icons/steps-tornado-${index + 1}.png`;
